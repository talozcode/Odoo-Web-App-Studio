...
export function ContactSection() {
  return (
    <section
      ...
      className="border-b border-[var(--border)] bg-[var(--odoo-purple)]/5"
    >
      <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8">
        <div className="mx-auto flex max-w-xl flex-col items-center text-center">
          <div className="flex h-12 w-12 items-center justify-center rounded-full bg-[var(--odoo-purple)]/10">
            <MessageSquareText aria-hidden="true" className="h-6 w-6 text-[var(--odoo-purple)]" />
          </div>
